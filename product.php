...
class Products
{
    ...
    public function __construct($title, $marque, $modele, $puissance, $annee, $description, $prixDepart, $dateFin, $dateDebut, $image_name)
    {
        $this->title = $title;
        $this->marque = $marque;
        $this->modele = $modele;
...
//******** */ pour afficher les elements de Product ***************
