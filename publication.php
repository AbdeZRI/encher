...
<body>
    ...
    <form action="publication.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="button" value="afficher plus" onclick="redirectToDetailsPage()">
    ...
    <script>
        function redirectToDetailsPage() {
            window.location.href = 'afficher_donnees.php';
        }
    </script>
...
if (isset($_POST["submit"])) {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        if (!empty($_POST["title"]) && !empty($_POST["marque_voiture"]) && !empty($_POST["modele_voiture"]) && !empty($_POST["puissance_voiture"]) && !empty($_POST["annee_voiture"]) && !empty($_POST["description"]) && !empty($_POST["prix_depart"]) && !empty($_POST["date_fin"]) && !empty($_POST["dateDebut"])) {
            ...
            $product= new Products ($title,$marque,$modele,$puissance,$annee,$description,$prixDepart,$dateFin,$dateDebut, $image_name);
